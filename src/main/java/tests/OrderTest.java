...
public class OrderTest extends BaseTest{
	 ...
	 public static void main(String[] args) throws InterruptedException {
      ...
      // Thread.sleep(3000);
       ...
       System.out.println("Total Products in Cart: "+cart.checkCartCount());
       
       cart.checkCartProdNames();
       
       cart.validateCartActualProducts();
       
       cart.checkCartPriceProdCount();
       
       cart.checkOriginalPriceDetails();
    
       base.tearDown();
       
       base.generateReportAndCleanup(OrderTest.class);
   }
